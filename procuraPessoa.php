<?php
    ...
    $pesquisa = '%' . $Nome . '%';
    $PDO = db_connect();
    $sql = "SELECT Pe.id, Pe.Nome, Pe.Idade, Ti.descricao FROM pessoas as Pe inner join tipo as Ti on Pe.tipoid = Ti.id WHERE upper(Pe.Nome) like :Nome";
...
<body>
        <div class="container">
        <div class="jumbotron">
                <p class="h3 text-center">Pessoas cadastrados encontradas na pesquisa</p>
        </div>
